...
class Map_Creation():
    ...
    def select_scenary(self, map_type: str, path_to_patron_q_table: Optional[str] = None, path_to_altruist_q_table: Optional[str] = None):
            ...
            case "4":
                ...
                match pod_scenary:
                    ...
                    case "3":
                        agent_patron_status = "trained"
                        agent_altruist_status = "training"
        return size_x, size_y, agent_patron_start_zone, agent_altruist_start_zone, target_location, walls_positions, doors_positions, agent_patron_status, agent_altruist_status